        ...
        {loading ? (
          ...
          <div>
            ...
            <div className="text-gray-600">
              ...
              <p><strong>CNIC:</strong> {loanData?.cnic}</p>
              <p><strong>Location:</strong> {loanData?.location}</p>
              <p><strong>Bank Name:</strong> {loanData?.bankName}</p>
              <p><strong>Branch Code:</strong> {loanData?.branchCode}</p>
              <p><strong>Account Number:</strong> {loanData?.accountNumber}</p>
              <p><strong>Permission Address:</strong> {loanData?.permissionAddress}</p>
            </div> */}
